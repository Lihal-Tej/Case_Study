...
!function(t,e,n){var a,i="mThumbnailScroller",
	o="mTS",r=".mThumbnailScroller",
	l={setTop:0,setLeft:0,type:"hover-50",
		axis:"x",speed:15,contentTouchScroll:25,markup:{buttonsPlaceholder:!1,
			buttonsHTML:{up:"SVG set 1",down:"SVG set 1",left:"SVG set 1",right:"SVG set 1"}},
			advanced:{autoExpandHorizontalScroll:!0,updateOnContentResize:!0,updateOnImageLoad:!0},theme:"none",
			callbacks:{onTotalScrollOffset:0,onTotalScrollBackOffset:0,alwaysTriggerOffsets:!0}},s=0,c={},d=e.attachEvent&&!e.addEventListener?1:0,
					u=!1,
		h=["mTS_disabled","mTS_destroyed","mTS_no_scroll"],
		f={init:function(e){var e=t.extend(!0,{},l,e),n=p.call(this);
		if(e.live){var a=e.liveSelector||this.selector||r,i=t(a);if("off"===e.live)return void v(a);c[a]=setTimeout(function(){i.mThumbnailScroller(e),
			"once"===e.live&&i.length&&v(a)},500)}else v(a);return e.speed=0===e.speed?100:e.speed,m(e),
					t(n).each(function(){var n=t(this);if(!n.data(o)){n.data(o,{idx:++s,opt:e,html:null,overflowed:null,bindEvents:!1,tweenRunning:!1,
						langDir:n.css("direction"),cbOffsets:null,trigger:null});var a=n.data(o).opt,i=n.data("mts-axis"),r=n.data("mts-type"),
						l=n.data("mts-theme");i&&(a.axis=i),r&&(a.type=r),l&&(a.theme=l,m(a)),x.call(this),f.update.call(null,n)}})},
	update:function(e){var n=e||p.call(this);return t(n).each(function(){var e=t(this);if(e.data(o)){var n=e.data(o),a=n.opt,i=t("#mTS_"+n.idx+"_container");
	if(!i.length)return;n.tweenRunning&&R(e),e.hasClass(h[0])&&e.removeClass(h[0]),e.hasClass(h[1])&&e.removeClass(h[1]),b.call(this),g.call(this),
	n.overflowed=_.call(this),k.call(this),M.call(this);var r=[i[0].offsetTop,i[0].offsetLeft];"x"!==a.axis&&(n.overflowed[0]?U(e,r[0].toString(),
			{dir:"y",dur:0,overwrite:"none"}):(y.call(this),"y"===a.axis?(U(e,"0",{dir:"y",dur:0,overwrite:"none"}),
	C.call(this)):"yx"===a.axis&&n.overflowed[1]&&U(e,r[1].toString(),{dir:"x",dur:0,overwrite:"none"}))),"y"!==a.axis&&(n.overflowed[1]?U(e,r[1].toString(),
			{dir:"x",dur:0,overwrite:"none"}):(y.call(this),"x"===a.axis?(U(e,"0",{dir:"x",dur:0,overwrite:"none"}),
